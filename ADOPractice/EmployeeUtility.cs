...
namespace ADOPractice {
    class EmployeeUtility {
        static string connectionString = "data source=.;database=SQLPractice;Integrated Security=true";
        ...
        public string GenerateEmail(string firstName, string lastName, DateTime dob) {
            string fN = firstName.ToLower(), lN = lastName.ToLower();
            return fN[0].ToString() + lN[0].ToString() + dob.Day.ToString("00") + fN + dob.Month.ToString("00") + lN + dob.Year.ToString("0000") + "@domainemployee.com";
        }
        ...
        public int Store(string firstName, string lastName, string mobileNo, string pincode, DateTime dob, string email, string password) {
        ...
        public Dictionary<string, string> ReadTable() {
